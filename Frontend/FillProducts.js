...
function ProductsCatLoad(ImagesPath, Prices, Weight, ProdName) {
        ...
        <div class="productCard">
            <div class="cardContainer">
                <img id="prodImg" src="${ImagesPath[i]}" alt="RedApplePhoto">
                    ...
                    <h6>${Weight[i]}г</h6>
                    <h5>${ProdName[i]}</h5>
                    <button><img src="Assets/Images/Icons/PlusBtnSim.svg" alt="PlusBtn"></button>
            </div>
        `;
        console.log("FDUNASD");
    }
...
VegetablesCat.addEventListener("click", () => ProductsCatLoad(VegetablesImagesPath, VegetablesPrices, VegetablesWeight, VegetablesName));
SnacksCat.addEventListener("click", () => ProductsCatLoad(SnacksImagesPath, SnackPrices, SnackWeight, SnacksName));
DrinksCat.addEventListener("click", () => ProductsCatLoad(DrinksImagesPath, DrinksPrices, DrinksWeight, DrinksName));
FruitsCat.addEventListener("click", () => ProductsCatLoad(FruitsimagesPath, FruitsPrices, FruitsWeight, FruitsName));
